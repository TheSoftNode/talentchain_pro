...
interface SimpleWeb3AuthProviderProps {
  children: ReactNode;
...
export function SimpleWeb3AuthProvider({ children, web3authInitialState }: SimpleWeb3AuthProviderProps) {
    ...
    return (
      <QueryClientProvider client={queryClient}>
        <div className="p-4 bg-red-50 border border-red-200 rounded-lg m-4">
          ...
          <p className="text-sm text-gray-600 mt-2">Please check your .env.local file for NEXT_PUBLIC_WEB3AUTH_CLIENT_ID</p>
        </div>
      </QueryClientProvider>
    );
  }
