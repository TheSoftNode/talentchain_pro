          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base lg:text-lg text-slate-600 dark:text-slate-300 max-w-xl lg:max-w-2xl mx-auto mb-4 sm:mb-6 leading-relaxed">
                Join the first platform to tokenize human capital as Real World Assets. Earn yield on your skills, access DeFi lending, and trade reputation across protocols.
              </p>
