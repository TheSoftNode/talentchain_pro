...
const features = [
  {
    icon: Shield,
    title: "Human Capital RWA",
    description: "Transform your skills into tokenized Real World Assets. Non-transferable skill tokens create verifiable, tradeable credentials on Solana.",
    color: "text-hedera-600 dark:text-hedera-400"
  },
  {
    icon: Users,
    title: "AI Skill Verification",
    description: "Advanced AI models verify and score your capabilities through comprehensive assessments, creating trusted human capital valuations.",
    color: "text-pink-600 dark:text-pink-400"
  },
  {
    icon: TrendingUp,
    title: "DeFi Lending Protocol",
    description: "Use your tokenized skills as collateral for loans. Earn yield on your human capital through our innovative DeFi lending platform.",
    color: "text-warning-600 dark:text-warning-400"
  },
  {
    icon: Lock,
    title: "Cross-Chain Bridge",
    description: "Seamlessly transfer your reputation and assets between different blockchain networks with our secure cross-chain infrastructure.",
    color: "text-hedera-600 dark:text-hedera-400"
  },
  {
    icon: Zap,
    title: "Web3Auth Integration",
    description: "Access your assets instantly with embedded wallets. No complex wallet setup - authenticate with social logins and start trading.",
    color: "text-pink-600 dark:text-pink-400"
  },
  {
    icon: Award,
    title: "Liquid Reputation",
    description: "Convert your work history into liquid assets. Stake, trade, and leverage your professional reputation across DeFi protocols.",
    color: "text-warning-600 dark:text-warning-400"
  }
];
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black tracking-tight leading-tight mb-3 sm:mb-4">
            ...
            <span className="relative text-hedera-600 dark:text-hedera-400 font-extrabold">
              <span className="relative z-10">as Real World Assets</span>
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-600 dark:text-slate-300 max-w-lg sm:max-w-xl lg:max-w-2xl mx-auto leading-relaxed">
            Tokenize skills, collateralize talent, and trade reputation in the world's first human capital DeFi ecosystem
          </p>
        </motion.div>
