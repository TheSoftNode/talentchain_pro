...
const steps = [
  {
    ...
    description: "Link your Solana wallet or use Web3Auth social login to access the first human capital RWA platform.",
    icon: Wallet
  },
  {
    step: "02",
    title: "Mint RWA Tokens",
    description: "Transform your skills into AI-verified Real World Assets. Each token represents tradeable human capital with DeFi utility.",
    icon: Award
  },
  {
    step: "03",
    title: "Earn & Leverage",
    description: "Use your skill tokens as collateral for loans, stake for yield, or trade reputation across DeFi protocols.",
    icon: TrendingUp
  }
];
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-600 dark:text-slate-300 max-w-lg sm:max-w-xl lg:max-w-2xl mx-auto leading-relaxed">
            Transform your skills into profitable Real World Assets in three simple steps
          </p>
        </motion.div>
