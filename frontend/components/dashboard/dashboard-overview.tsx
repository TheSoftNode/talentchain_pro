      ...
      >
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 text-sm text-slate-600 dark:text-slate-400">
            <span className="text-base">Track your Human Capital Assets and DeFi opportunities</span>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">
                Maximize Your RWA Value
              </h3>
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                Use AI-verified skills as collateral for DeFi loans. Higher skill levels unlock better lending rates,
                staking rewards, and cross-chain liquidity opportunities on Solana.
              </p>
            </div>
          </div>
        </motion.div>
