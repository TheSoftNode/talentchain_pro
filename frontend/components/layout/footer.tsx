...
const footerSections = [
  {
    title: "Platform",
    links: [
      { name: "RWA Tokens", href: "/skill-tokens" },
      { name: "AI Verification", href: "/ai-matching" },
      { name: "DeFi Lending", href: "/reputation" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
          ...
          >
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 max-w-sm leading-relaxed">
              The first platform to tokenize human capital as Real World Assets. AI-verified talent tokens with DeFi utility and cross-chain reputation.
            </p>
            ...
            <div className="flex items-center space-x-2 px-3 py-1.5 rounded-full bg-success-50/50 dark:bg-success-900/20 border border-success-200/30 dark:border-success-800/30 w-fit">
              ...
              <span className="text-xs font-medium text-success-700 dark:text-success-400">Solana Devnet</span>
            </div>
