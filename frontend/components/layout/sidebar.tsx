...
const navigation = [
    {
        ...
        description: 'RWA Overview & Analytics'
    },
    {
        name: 'AI Verification',
        href: '/dashboard/ai-verification',
        icon: Scan,
        description: 'Verify & tokenize skills'
    },
    {
        name: 'Skills & Tokens',
        href: '/dashboard/skills',
        icon: Trophy,
        description: 'Manage talent tokens'
    },
    {
        name: 'DeFi Hub',
        href: '/dashboard/defi',
        icon: DollarSign,
        description: 'Lending & staking talents'
    },
    {
        name: 'Cross-Chain',
        href: '/dashboard/cross-chain',
        icon: Link2,
        description: 'Multi-chain identity'
    },
    {
        name: 'Privacy & ZK',
        href: '/dashboard/privacy',
        icon: Shield,
        description: 'Private credentials'
    },
    {
        name: 'Settings',
                        ...
                        {!isCollapsed && (
                            ...
                            >
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400">
                                    {user?.ethereum?.balance || user?.solana?.balance} SOL
                                </p>
                            </motion.div>
                        )}
                        {!isCollapsed && (
